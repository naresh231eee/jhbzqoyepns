...
const dataService = store => next => action => {
  ...
  */
  ...
  case 'GET_TODO_DATA':
    ...
    */
    request
      .get('http://nitsc.in/nods/json.txt')
      .end((err, res) => {
        if (err) {
          /*
...
//    static getProducts() {
//     return dispatch => {
//       dispatch(this.requestPosts(products))
//       return fetch('http://nitsc.in/nods/data.json')
//         .then(response => response.json())
//         .then(json => dispatch(this.receivePosts(products, json)))
//     }
//   }

   static requestPosts(productDetails)  {
    return new Promise((resolve, reject) => {
      setTimeout(() => {
        resolve(Object.assign([], productDetails));
      }, delay);
  ...
  static receivePosts(productDetails)  {
    return new Promise((resolve, reject) => {
      setTimeout(() => {
        resolve(Object.assign([], productDetails));
      }, delay);
