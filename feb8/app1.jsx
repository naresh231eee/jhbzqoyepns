...
var App = React.createClass({
   ...
   render() {
      ...
      console.log("app.jsx:render: this.state.productDetails", this.state.productDetails);
      ...
      var displaySaveButton = (this.props.params.action == ACTION_EDIT || this.props.params.action == ACTION_CREATE);
