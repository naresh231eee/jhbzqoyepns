      ...
      return (
         <div className="wrapper">
            ...
            <div className="container">
               <div className="row bankEntity currencyCol scrollablediv">
                     <div className="col-md-12">
                        ...
                        <div className="col-md-1">
                           <div className="form-group">
                              <label htmlFor="backToBack">Reference Rate<span> *</span></label>

                           </div>
                        </div>
                        <div className="col-md-1">
                           <div className="form-group">
                              <label htmlFor="settledCashOnly">Banking Book</label>

                           </div>
                        </div>
                        <div className="col-md-2">
                           <div className="form-group">
                              <label htmlFor="issuer">Trading Book</label>
                           </div>
                        </div>
                        <div className="col-md-2">
                           <div className="form-group">
                              <label htmlFor="securityType">Fixed</label>

                           </div>
                        </div>
                        <div className="col-md-2">
                           <div className="form-group">
                              <label htmlFor="benchmark">Floating</label>

                           </div>
                        </div>
                        <div className="col-md-2">
                           <div className="form-group">
                              <label htmlFor="benchmark">Short Position</label>

                           </div>
                        </div>
                        <div className="col-md-2">
                           <div className="form-group">
                              <label htmlFor="benchmark">Open Risk</label>

                           </div>
                        </div>
                        <div className="col-md-2">
                           <div className="form-group">
                              <label htmlFor="benchmark">Open Risk Max Tenor</label>

                           </div>
                        </div>
                        <div className="col-md-2">
                           <div className="form-group">
                              <label htmlFor="benchmark">Balance Sheet</label>

                           </div>
                        </div>
                        <div className="col-md-2">
                           <div className="form-group">
                              <label htmlFor="benchmark">SME Segment</label>

                           </div>
                        </div>
                        <div className="col-md-2">
                           <div className="form-group">
                              <label htmlFor="benchmark">Exchange Symbol</label>

                           </div>
                        </div>
                        <div className="col-md-2">
                           <div className="form-group">
                              <label htmlFor="benchmark">Exchange</label>

                           </div>
                        </div>
                        <div className="col-md-2">
                           <div className="form-group">
                              <label htmlFor="benchmark">OTC</label>

                           </div>
                        </div>
                        <div className="col-md-2">
                           <div className="form-group">
                              <label htmlFor="benchmark">Exchange Platform</label>

                           </div>
                        </div>
                        <div className="col-md-2">
                           <div className="form-group">
                              <label htmlFor="benchmark">Region</label>

                           </div>
                        </div>
                        <div className="col-md-2">
                           <div className="form-group">
                              <label htmlFor="benchmark">Clearing Agent</label>

                           </div>
                        </div>
                        <div className="col-md-2">
                           <div className="form-group">
                              <label htmlFor="benchmark">CCP ONLY</label>

                           </div>
                        </div>
                        <div className="col-md-2">
                           <div className="form-group">
                              <label htmlFor="benchmark">Escalation Condition</label>

                           </div>
                        </div>
                        <div className="col-md-2">
                           <div className="form-group">
                              <label htmlFor="benchmark">Trade Settlement - Cash</label>

                           </div>
                        </div>
                        <div className="col-md-2">
                           <div className="form-group">
                              <label htmlFor="benchmark">Trade Settlement - Physical</label>

                           </div>
                        </div>
                        <div className="col-md-2">
                           <div className="form-group">
                              <label htmlFor="benchmark">Underlying Status</label>

                           </div>
                        </div>
                        <div className="col-md-2">
                           <div className="form-group">
                              <label htmlFor="benchmark">Date Of Underlying Status Change</label>

                           </div>
                        </div>
                        <div className="col-md-2">
                           <div className="form-group">
                              <label htmlFor="benchmark">Min Amount</label>

                           </div>
                        </div>
                        <div className="col-md-2">
                           <div className="form-group">
                              <label htmlFor="benchmark">Max Time</label>

                           </div>
                        </div>
                        <div className="col-md-2">
                           <div className="form-group">
                              <label htmlFor="benchmark">Deferred Settlement Period</label>

                           </div>
                        </div>
                        <div className="col-md-2">
                           <div className="form-group">
                              <label htmlFor="benchmark">Days Permitted</label>
            ...
            { this.state.bankEntityRows.bankEntityCurrencies && this.state.bankEntityRows.bankEntityCurrencies.length > 0 && (
               this.state.bankEntityRows.bankEntityCurrencies).map((row, index) => (
               <AddBankEntityRow
                  //key={'BankEntityRow'+index+Math.random()}
                  key={'BankEntityRow'+index}
                  tradingIndex={this.props.tradingIndex}
                  bankentityIndex={this.props.bankentityIndex}
                  rowIndex={index}
                  //dataEntityRow={row}
                  bankEntityCurrencies={row}
                  //lengthRows={this.props.data.length}
