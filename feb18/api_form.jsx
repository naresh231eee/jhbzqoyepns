...
export const TRI_PARTY_REPO = {attrName: 'Tri Party Repo', attrValue: ""};
export const PRE_TRADE_RESTRICTION = {attrName: "Pre Trade Restrictions - Refer to Policy", attrValue: ""};
export const NOTICE_PERIOD_DAYS = {attrName: "Notice Period Days", attrValue: ""};
