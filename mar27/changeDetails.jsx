...
var ChangeDetails = React.createClass({
   ...
   getRefDataValueForKey: function(key) {
      ...
      // console.log("key cd get::::::", key);
      // console.log("> cd getRefDataValueForKey::::::", this.props.refData);
      // console.log("> cd getRefDataValueForKey get::::::", this.props.refData.get(key));
