...
var Home = React.createClass({
   ...
   componentWillMount: function(){
    ...
    // console.log(landingPage);
      this.setState({products: landingPage.landingAPI.data, user: null});
   },
   errorMessagesHide(){
    ...
    render() {
        let currentUser = (!_.isNil (this.state.user)) ? this.state.user.prinicipal.username : "Guest";
       ...
       var messageColour = this.state.isSuccess? "green" : "red";
        ...
        <div className="container-fluid">
            ...
            <div className="row main-content">
                <ProductPendingInitiation products={this.state.products} user={currentUser} headerText={HOME_HEADER} />
            </div>
        </div>
