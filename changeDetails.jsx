...
var ChangeDetails = React.createClass({
   ...
   getInitialState: function () {
      console.log("changeDetails:getInitialStatess.mandatoryRerender", this.props.mandatoryRerender);
      return {
   ...
   componentWillReceiveProps: function (newProps) {
      ...
      console.log("changeDetails:componentWillReceiveProps.mandatoryRerender", newProps.mandatoryRerender)
