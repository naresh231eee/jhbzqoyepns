...
export const BALANCE_SHEET = {key:'balanceSheet',name: 'Balance Sheet', editorKey:'balanceSheet', editable:true, width:120};
export const APD_CURRENCY = {key:'currency1',name: 'CCY1', editorKey:'currency1', editable:true, width:60};
export const REFERENCE_RATE = {key:'referenceRate',name: "Reference Rate", editorKey:'referenceRate', editable:true, width:120};
export const EXCHANGE = {key:'exchange',name: 'Exchange', editorKey:'exchange', editable:true, width:80};
export const EXCHANGE_SYMBOL = {key:'exchangeSymbol',name: 'Exchange Symbol', editable:true, width:140};
export const EXCHANGE_PLATFORM = {key:'exchangePlatform',name: 'Exchange Platform', editorKey:'exchangePlatform', editable:true, width:140};
export const MAX_TENOR = {key:'maxTenor',name: 'Max Tenor', editorKey:'maxTenor', editable:true, width:100};
export const OPEN_RISK = {key:'openRisk',name: 'Open Risk', editorKey:'openRisk', editable:true, width:100};
export const OPEN_RISK_MAX_TENOR = {key:'openRiskMaxTenor',name: 'Open Risk Max Tenor', editorKey:'openRiskMaxTenor', editable:true, width:100};
export const TRADE_SETTLEMENT_CASH = {key:'tradeSettlementCash',name: 'Trade Settlement - Cash', editorKey:'tradeSettlementCash', editable:true, width:180};
export const TRADE_SETTLEMENT_PHYSICAL = {key:'tradeSettlementPhysical',name: 'Trade Settlement - Physical', editorKey:'tradeSettlementPhysical', editable:true, width:100};
export const UNDERLYING_STATUS = {key:'underlyingStatus',name: 'Underlying Status', editorKey:'underlyingStatus', editable:true, width:160};
export const UNDERLYING_STATUS_CHANGE_DATE = {key:'underlyingStatusChangeDate',name: 'Underlying Status Change Date', editor: false, editorKey:'underlyingStatusChangeDate', editable:false, width:160};
...
export const CCY1 = {key:'currency1',name: 'CCY1', editorKey:'currency1', editable:true, locked: true, width:60};
export const CCY2 = {key:'currency2',name: 'CCY2', editorKey:'currency2', editable:true, locked: true, width:60};
export const BANKING_BOOK = {key:'bankingBook',name: 'Banking Book', editorKey:'bankingBook', editable:true, width:50};
export const CALLABLE_ALLOWED = {key:'callable',name: 'Callable - Allowed', editorKey:'callable', editable:true, width:120};
export const CONVERTIBLE_ALLOWED = {key:'convertible',name: 'Convertible - Allowed', editorKey:'convertible', editable:true, width:90};
export const OTC = {key:'oTC',name: 'OTC', editorKey:'oTC', editable:true, width:50};
export const TRADING_BOOK = {key:'tradingBook',name: 'Trading Book', editorKey:'tradingBook', editable:true, width:80};
export const ISSUER = {key:'issuer',name: 'Issuer', editorKey:'issuer', editable:true, width:100};
export const SECURITY_TYPE = {key:'securityType',name: 'Security Type', editorKey:'securityType', editable:true, width:120};
export const CLEARING_AGENT = {key:'clearingAgent',name: 'Clearing Agent', editorKey:'clearingAgent', editable:true, width:110};
export const SHORT_POSITION = {key:'shortPosition',name: 'Short Position', editorKey:'shortPosition', editable:true, width:110};

export const DEFERRED_SETTLEMENT_PERIOD = {key:'deferredSettlementPeriod',name: 'Deferred Settlement Period', editorKey:'deferredSettlementPeriod', editable:true, width:110};
...
export const MM_FEATURES = [TRI_PARTY_REPO, PRE_TRADE_RESTRICTION, NOTICE_PERIOD_DAYS];
...
export const COMMODITIES_FEATURES =[CORE_ASSETS, SUB_CATEGORY, SUB_ASSETS, COMMODITIES_REGION,
                                    PRODUCT_GRADE, BASIS, PRICE_SOURCE, BBG_PLATTS_CODE_FUTURE_TICKER
                                   ];
...
export const CREDIT = {attrName: 'Business Control', attrValue: "", key:'Credit',name: 'Credit', editorKey:'Credit', editable:true, width:160};
export const BUSINESS_CONTROL = {attrName: 'Business Control', attrValue: "", key:'Business Control',name: 'Business Control', editorKey:'Business Control', editable:true, width:110};
export const OPERATIONS = {attrName: 'Operations', attrValue: "", key:'Operations',name: 'Operations', editorKey:'Operations', editable:true, width:70};
export const RISK_PLATFORMS = {attrName: 'Risk Platforms', attrValue: "", key:'Risk Platforms',name: 'Risk Platforms', editorKey:'Risk Platforms', editable:true, width:110};
...
export const LIMIT_DOLLAR_M = {attrName: 'Limit £m', attrValue: "", key:'Limit £m',name: 'Limit £m', editor:false, editorKey:'Limit £m', editable:true, width:70};
...
export const CREDIT_FEATURES =[MODAL_VAL_APPROVAL_YRS, MARKET_RISK_APPROVAL_TRADES_PER_YR, CREDIT_RISK_HEDGED, CREDIT,
   BUSINESS_CONTROL, OPERATIONS, RISK_PLATFORMS, TWO_WAY_LETTER_REQUIRED, LIMIT_DOLLAR_M, MAX_HOLDING_PERIOD_DAY,
   MAX_TRADES_PER_YR, MAX_TOTAL_EXECUTED_TRADES
];
...
export const RATES_FEATURES =[NOTIFY_MARKET_RISK_TENOR_GREATER_THAN];
...
/************* FX Features **********************/
export const APPLICABLE = { attrName: 'Applicable', attrValue: "", key:'Applicable', name: 'Applicable', editorKey:'Applicable', editable:true, width:100};
export const TRIGGER = { attrName: 'Trigger', attrValue: "", key:'Trigger', name: 'Trigger', editor:false, editorKey:'Trigger', editable:true, width:100};
...
export const ALLOWED = { attrName: 'Allowed', attrValue: "", key:'Allowed', name: 'Allowed', editorKey:'Allowed', editable:true, width:100};
export const APPROVAL_BY_BUSINESS_CONTROL_AND_MODAL_VAL = { attrName: 'Approval by Business Control and Model Val', attrValue: "", key:'Approval by Business Control and Model Val', name: 'Approval by Business Control and Model Val', editorKey:'Approval by Business Control and Model Val', editable:true, width:100};
...
export const APPROVAL_FOR_TENOR_GREATER_YRS = { attrName: 'Approval For Tenor > Yrs', attrValue: "", key:'Approval For Tenor > Yrs', name: 'Approval For Tenor > Yrs', editor:false, editorKey:'Approval For Tenor > Yrs', editable:true, width:100};
...
export const FX_FEATURES =[APPLICABLE,TRIGGER,OUTRIGHT_TRADING_PERMITTED,PERMITTED_UPTO_VALUE_DATE_FOR_SPOT, OPTION_WINDOW,
   EXTENDED_OPTION_WINDOW, MAX_TENOR_INCL_OPTION_WINDOW,OPTIONS_WINDOW_TRADE_DATE_MONTHS,ALLOWED,APPROVAL_BY_BUSINESS_CONTROL_AND_MODAL_VAL,
   MAX_MONTHS,IF_DEFERRED_SETTLEMENT_APPROVED,TARN_FIXING_DATE_ONLY,MAX_GAP_BETWEEN_FIXING_DATES,APPROVAL_FOR_TENOR_GREATER_YRS,
   MAX_SIZE_PER_TRADE,MAX_TRADES_PER_YR_FX,MARKET_RISK_WHEN_TRADE_SIZE_GREATER_THAN,MODEL_RISK_WHEN_TRADE_GREATER_THAN
];
