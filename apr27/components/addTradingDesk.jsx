...
var AddTradingDesk = React.createClass({
        ...
        handleInputChange(e) {
         ...
         handleUnderlyingTrading(e) {
                var trading = this.state.trading;
                var id = e.target.id;
                console.log(id)
                var column = id.split("_")[1];
                if(confirm("Are you sure you want to change statuses in this trading desk")){
               var value = e.target.value;
                this.props.updateUnderlyingStatus(column, value);
                }
                /*console.log('this.state.trading', this.state.trading);
                this.state.trading =  this.totalTradingUnderlyingStatus(column[1], value);
                this.forceUpdate();*/
                // trading[column] = value;
                // this.setState(trading);
        },
        ...
        componentDidMount(){
                this.enableDisableExternal(this.props.tradingIndex, true)
        },
        render() {
                //Trading Desk
                ...
                /*this.state.sMESegmentDisabled = false;
                  ...
                  console.log('this.state.deskStatus --> ', this.state.trading);
                  console.log(this.state.trading.deskStatus);
                return (
                                        ...
                                        <div className="container txt-color">
                                                ...
                                                {this.state.bankEntities.length > 0 && (this.state.bankEntities).map((result, index) => (
                                                        <AddBankEntity key={'MulitBank' + index}
                                                                ...
                                                                handleUnderlyingRows={this.props.handleUnderlyingRows}
