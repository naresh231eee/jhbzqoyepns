      ...
      for(var i=0; i<columns.length;i++){
        ...
        //   console.log(columns[i].key);
         ...
         var newColumn =  {
            key: columns[i].key,
            name: columns[i].name,
            editor : (!_.isNil(columns[i].editor)) ? columns[i].editor : <AutoCompleteEditor key={columns[i].editor} options={this.formatRefDataForGrid(this.getRefDataValueForKey(columns[i].name))} />,
